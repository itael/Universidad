...
public class ConsoleApp {
    ...
    public static void main(String[] args) throws Exception {
        ...
        while (!salir) {
            ...
            System.out.println("4. Adicionar deportistas");
            System.out.println("5. Mostrar pomedio edad del ministerio");
            ...
            try {
                ...
                switch (opcion) {
                    ...
                    case 4:
                        ...
                        ministerio.adicionarDeportista(deportista);

                        break;
                    case 5:
                        System.out.println("El promedio de edad es: "+ministerio.promedioEdad());
